...
testPerson1a = CustomerContact(first_name='Tasnim', last_name='Begum', date_of_birth='1998-09-08', phone_number='07497500204', address_line='28 London Street', postcode="KT5 8AT",  city="Nottingham")
testPerson2a = CustomerContact(first_name='Dwayne', last_name='Johnson', phone_number='07946183457',date_of_birth='1972-05-01', address_line='1 The Green', postcode="SE11 5SS",  city="Reading")
testPerson3a = CustomerContact(first_name='Beyonce', last_name='Knowles-Carter', date_of_birth='1981-09-04', phone_number='07946512396', address_line='21 Jump Street', postcode="B2P AJ9",  city="Birmingham")
tas_login = CustomerLogin(email_address='tasnim.b98@gmail.com', password="sha256$n2JF3o03$9f93108a285f8dc675c9371c14f69dd16758ed5278ae0ca7728c7c1242c6cf88")
rock_login = CustomerLogin(email_address='dwayne@fastcars.com', password="sha256$n2JF3o03$9f93108a285f8dc675c9371c14f69dd16758ed5278ae0ca7728c7c1242c6cf88")
beyonce_login = CustomerLogin(email_address='beyonce@halo.com', password="sha256$n2JF3o03$9f93108a285f8dc675c9371c14f69dd16758ed5278ae0ca7728c7c1242c6cf88")
