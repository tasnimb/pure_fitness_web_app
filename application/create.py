...
testPerson1a = CustomerContact(first_name='Tasnim', last_name='Begum', phone_number='07497500204', address_line='28 London Street', postcode="KT5 8AT",  city="Nottingham")
testPerson2a = CustomerContact(first_name='Dwayne', last_name='Johnson', phone_number='07946183457', address_line='1 The Green', postcode="SE11 5SS",  city="Reading")
testPerson3a = CustomerContact(first_name='Beyonce', last_name='Knowles-Carter', phone_number='07946512396', address_line='21 Jump Street', postcode="B2P AJ9",  city="Birmingham")
