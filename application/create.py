...
tas_login = CustomerLogin(email_address='tasnim.b98@gmail.com', password="forgot!")
rock_login = CustomerLogin(email_address='dwayne@fastcars.com', password="yourewelcome")
beyonce_login = CustomerLogin(email_address='beyonce@halo.com', password="ringonit")
