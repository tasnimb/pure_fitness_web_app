...
class CustomerContact(db.Model):
    ...
    customer_name_id_a = db.Column(db.Integer, db.ForeignKey('CustomerName.customer_name_id'))
...
class BookActivity(db.Model):
    ...
    ActivityTimeslot = db.relationship("ActivityTimeslot")
    ActivityTime = db.relationship("ActivityTime")
